...
contract MockStakingUsdxMoney {
    ...
    constructor(
        ...
        require(_mockWETH != address(0), "Invalid token address");
    ...
    function stake(uint256 _days, uint256 _amount) external {
        ...
        mockWETH.transferFrom(msg.sender, address(this), _amount);
    ...
    function emergencyWithdraw(uint256 _amount) external {
        ...
        mockWETH.transfer(msg.sender, finalAmount);
    ...
    function withdraw(uint256 _amount) external {
        ...
        mockWETH.transfer(msg.sender, totalToPay);
    ...
    function withdrawToOwner() external {
        ...
        mockWETH.transfer(owner, mockWETH.balanceOf(address(this)));

        emit WithdrawAll(owner, mockWETH.balanceOf(address(this)));
    }
